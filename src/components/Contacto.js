...
const Contacto = () => {
  return (
    <div className="relative w-full">
      <section id="contacto" className="h-[50vh] lg:h-screen bg-blue-200 flex justify-center items-center">
      ...
      <div className="form w-full lg:w-auto relative lg:absolute right-0 lg:right-48 bottom-0 lg:bottom-8 2xl:bottom-[10vh]">
        <ContactForm />
      </div>
    </div>
  );
